...
class NewOrUpdateEventFragment : Fragment() {
    ...
    private fun parseDateTime(dateTimeString: String) {
        ...
        if (BuildConfig.DEBUG) {
            Logger.i("NewOrUpdateEventFragment.parseDateTime: $dateTimeString")
            Logger.i("NewOrUpdateEventFragment.parseDateTime: $dateTimeFormat")
        }
        ...
        try {
            ...
            if (BuildConfig.DEBUG) {
                Logger.e("NewOrUpdateEventFragment.parseDateTime: $e")
            }
        }
    }
}
