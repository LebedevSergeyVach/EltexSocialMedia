...
class FragmentPostDetails : Fragment() {
        ...
        viewModel.state
            ...
            .onEach { state: PostDetailsState ->
                ...
                state.post?.let {
                    ...
                    updateLikeByMe(binding, state.post)
    ...
    private fun renderDataPost(
        ...
        binding.loginAndJob.text = post.authorJob ?: getString(R.string.user)
        binding.content.text = post.content
        binding.like.text = post.likes.toString()
        binding.buttonUpdate.isVisible = post.authorId == accountId
    }
    ...
    private fun renderingUserAvatar(post: PostUiModel, binding: FragmentPostDetailsBinding) {
